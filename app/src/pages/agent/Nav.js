        ...
        <>
            <div className="client-nav shadow">
                <ul>
                    ...
                    <li onClick={e => nav('/agent/earnings')}>  
                        <img src={cartSvg} style={{height: '20px', width: '20px', position: 'relative'}} alt="" />
                        <small><b>earnings</b></small>
                    </li>
                    <li>
                        <img src={addSvg} onClick={e => nav('/agent/space')} style={{height: '20px', width: '20px', position: 'relative'}} alt="" />
                        <small><b>create</b></small>
                    </li>
                    <li>
                        <img src={settingsSvg} onClick={e => nav('/agent/inbox')} style={{height: '20px', width: '20px', position: 'relative'}} alt="" />
