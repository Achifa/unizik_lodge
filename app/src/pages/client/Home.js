...
import { GET_AGENT_LODGE } from "../../axios/client";
                    ...
                    <div className="client-card shadow">
                        ...
                        <div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
                            ...
                            <div className="carousel-inner">
                                ...
                                {
                                    result.files.map(photo => 
                                        photo.lodgeid === item.lodgeid 
                                        ?
                                            <div className="carousel-item active" data-bs-interval="10000">

                                                {
                                                    photo.file.split(':')[1].split('').splice(0,5).join('') === 'image'
                                                    ?
                                                    <img src={photo.file} style={{height: '168px', width: '100%'}} alt="" />
                                                    :
                                                    <video src={photo.file} autoPlay style={{height: '168px', width: '100%'}}></video>
